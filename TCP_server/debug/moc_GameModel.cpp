...
QT_MOC_LITERAL(1, 10, 16), // "TurnToNextPlayer"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "GameModel\0TurnToNextPlayer\0"
};
...
void GameModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->TurnToNextPlayer(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameModel::TurnToNextPlayer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameModel::TurnToNextPlayer()
{
